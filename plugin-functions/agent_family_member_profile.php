...
$profile_type = $table_agent_family_member_profiles;
$result_profile = $wpdb->get_row( "SELECT * FROM $table_agent_family_member_profiles WHERE user_id = $user_id" );
$agent_family_member_profile_id = (int)$result_profile->id;
$string = '<form method="post">
<div id="wpja-identification">
<p><b>IDENTIFICATION</b></p>
        <table>
        <tr><td><label for="aname">Name</label></td>
        <td><input class="wpja-input" id="aname" type="text" name="aname" maxlength="100" value="'; 
        ...
        $string .= '"></td></tr>
        <tr><td><label for="family_relation">Family Relation</label></td>
        <td><input class="wpja-input" id="family_relation" type="text " name="family_relation" maxlength="100" value="'; 
        $string .= $result_profile->family_relation;
        $string .= '"></td></tr>
        </table>
        <input type="submit" name="submit-agent-family-member" value="Edit Profile">
        </div>
        </form>
        <div id="wpja-attachments">
        <form method="post" enctype="multipart/form-data">
        <label for="passport"><b>Passport</b></label><br>';
        $attachment_set = $wpdb->get_row("SELECT passport_url as attachment_url FROM $profile_type WHERE id = $agent_family_member_profile_id", ARRAY_A);
        ...
        <input class="wpja-input" type="hidden" name="profile_id" value="'.$agent_family_member_profile_id.'">
        ...
        $attachment_set = $wpdb->get_row("SELECT driving_licence_url as attachment_url FROM $profile_type WHERE id = $agent_family_member_profile_id", ARRAY_A);
        if($attachment_set['attachment_url'])
        {
              $string .= '<div class="wpja-attachment-set">
              <p><a href="'.$attachment_set['attachment_url'].'"><b>Attachment file</b></a><br /><b>This attachment is already set.</b> Change it below.</p>
        ...
        $attachment_set = $wpdb->get_row("SELECT ration_card_with_photo_url as attachment_url FROM $profile_type WHERE id = $agent_family_member_profile_id", ARRAY_A);
        if($attachment_set['attachment_url'])
        {
              $string .= '<div class="wpja-attachment-set">
              <p><a href="'.$attachment_set['attachment_url'].'"><b>Attachment file</b></a><br /><b>This attachment is already set.</b> Change it below.</p>
        ...
        $attachment_set = $wpdb->get_row("SELECT bank_ac_pass_book_with_photo_url as attachment_url FROM $profile_type WHERE id = $agent_family_member_profile_id", ARRAY_A);
        if($attachment_set['attachment_url'])
        {
              $string .= '<div class="wpja-attachment-set">
              <p><a href="'.$attachment_set['attachment_url'].'"><b>Attachment file</b></a><br /><b>This attachment is already set.</b> Change it below.</p>
        ...
        $attachment_set = $wpdb->get_row("SELECT bank_account_statement_url as attachment_url FROM $profile_type WHERE id = $agent_family_member_profile_id", ARRAY_A);
        if($attachment_set['attachment_url'])
        {
              $string .= '<div class="wpja-attachment-set">
              <p><a href="'.$attachment_set['attachment_url'].'"><b>Attachment file</b></a><br /><b>This attachment is already set.</b> Change it below.</p>
        ...
        $attachment_set = $wpdb->get_row("SELECT birth_certificate_url as attachment_url FROM $profile_type WHERE id = $agent_family_member_profile_id", ARRAY_A);
        if($attachment_set['attachment_url'])
        {
              $string .= '<div class="wpja-attachment-set">
              <p><a href="'.$attachment_set['attachment_url'].'"><b>Attachment file</b></a><br /><b>This attachment is already set.</b> Change it below.</p>
        ...
        $attachment_set = $wpdb->get_row("SELECT electricity_bill_url as attachment_url FROM $profile_type WHERE id = $agent_family_member_profile_id", ARRAY_A);
        if($attachment_set['attachment_url'])
        {
              $string .= '<div class="wpja-attachment-set">
              <p><a href="'.$attachment_set['attachment_url'].'"><b>Attachment file</b></a><br /><b>This attachment is already set.</b> Change it below.</p>
        ...
        $attachment_set = $wpdb->get_row("SELECT rent_agreement_url as attachment_url FROM $profile_type WHERE id = $agent_family_member_profile_id", ARRAY_A);
        if($attachment_set['attachment_url'])
        {
              $string .= '<div class="wpja-attachment-set">
              <p><a href="'.$attachment_set['attachment_url'].'"><b>Attachment file</b></a><br /><b>This attachment is already set.</b> Change it below.</p>
        ...
        $attachment_set = $wpdb->get_row("SELECT police_conduct_url as attachment_url FROM $profile_type WHERE id = $agent_family_member_profile_id", ARRAY_A);
        if($attachment_set['attachment_url'])
        {
              $string .= '<div class="wpja-attachment-set">
              <p><a href="'.$attachment_set['attachment_url'].'"><b>Attachment file</b></a><br /><b>This attachment is already set.</b> Change it below.</p>
